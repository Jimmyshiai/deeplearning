...
# The following import are used to be loaded from the directory of last level for jupyter notebook running.
# If this program is run in the current folder, please comment the following and uncomment the next block.

import google_text_classification.build_model as build_model
import google_text_classification.load_data as load_data
import google_text_classification.vectorize_data as vectorize_data
import google_text_classification.explore_data as explore_data
